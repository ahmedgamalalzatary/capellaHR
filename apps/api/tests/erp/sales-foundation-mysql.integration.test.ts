  ...
  it('enforces paid completion and valid immutable commission lineage', async () => {
    ...
    await expect(database.transaction(async (transaction) => {
      ...
      await transaction.insert(invoicePayments).values({
        ...
        method: 'cash',
        amount: '0.04',
        operationReference: '018f47a6-7b2f-7c41-91e9-a5dd1d8e1601',
        cashierSessionId,
        actingAccountId: accountId,
        paidAt: now,
        createdAt: now,
      ...
      await transaction.insert(invoicePayments).values({
        ...
        method: 'cash',
        amount: '0.04',
        operationReference: '018f47a6-7b2f-7c41-91e9-a5dd1d8e1602',
        cashierSessionId,
        actingAccountId: accountId,
        paidAt: now,
        createdAt: now,
      ...
      try {
        await transaction.insert(invoicePayments).values({
          ...
          method: 'visa',
          amount: '1.00',
          operationReference: '018f47a6-7b2f-7c41-91e9-a5dd1d8e1603',
          cashierSessionId,
          actingAccountId: accountId,
          paidAt: now,
          createdAt: now,
