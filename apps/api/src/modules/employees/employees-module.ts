...
export const createEmployeesModule = (database: ReturnType<typeof createDatabase>, attendance?: { hasOpenSession(id: number, context?: unknown): Promise<boolean> }, existingRepository?: ReturnType<typeof createDrizzleEmployeeRepository>) => {
