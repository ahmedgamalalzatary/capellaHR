...
### Milestone 1: Core operational completion

Build in this order:

1. Employee management UI
2. Employee branch assignment UI
3. Employee device setup UI
4. Employee attendance page and attendance action flow
5. Admin attendance management screens

Expected outcome:

- The product becomes operational for daily attendance usage.

### Milestone 2: HR policy and exceptions

Build in this order:

1. Weekly day-offs UI
2. Permission absences UI
3. Integrate both into employee/admin operational views

Expected outcome:

- The product handles normal scheduling exceptions and policy flows.

### Milestone 3: Oversight and controls
...
- The product becomes administratively usable for review, export, and period control.
...
- Shared contract layer: strong
- Frontend foundation: present but narrow
- Overall product completeness: partial

The main bottleneck is no longer backend surface area. The primary missing work is frontend feature implementation and end-to-end operational wiring across the already-existing backend domains.
