...
const isolatedSuites = [
  ...
  'tests/erp/sale-repository-payments-mysql.integration.test.ts',
  'tests/erp/sale-repository-roster-mysql.integration.test.ts',
  'tests/erp/sale-repository-line-reassignment-mysql.integration.test.ts',
  'tests/erp/sale-repository-payroll-mysql.integration.test.ts',
  'tests/erp/sale-repository-completion-mysql.integration.test.ts',
  'tests/erp/sale-repository-queue-reassignment-mysql.integration.test.ts',
  'tests/erp/sale-repository-invoice-history-mysql.integration.test.ts',
  'tests/erp/sale-repository-completion-guards-mysql.integration.test.ts',
  'tests/erp/sale-repository-completion-concurrency-mysql.integration.test.ts',
  'tests/erp/sale-repository-product-barcode-mysql.integration.test.ts',
  ...
  'tests/erp/sale-repository-voids-mysql.integration.test.ts',
  'tests/erp/sale-repository-reversal-concurrency-mysql.integration.test.ts',
  'tests/erp/sale-repository-reversal-guards-mysql.integration.test.ts',
