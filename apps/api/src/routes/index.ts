...
import { createErpClientsRouter, createErpExpensesRouter, createErpProductsRouter, type ClientService, type ExpenseService, type ProductStockService } from '../modules/erp/index.js';
import {
